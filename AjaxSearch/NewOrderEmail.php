...
<div style="padding: 20px;  width: auto;  font-size: 11pt; line-height:25px;  text-align: right;  font-family: Tahoma; " >سفارش جدیدی با کد پیگیریه ' . $_POST['code'] . '  به صورت پرداخت آنلاین ثبت شد. </div></div>
</body>
</html>
        ';
