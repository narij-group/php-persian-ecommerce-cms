...
$_SESSION[SESSION_STRING_ENTRY] = $_POST['entry'];
...
//                            $pmenu = $menu->GetMenusForOneProduct($p->ProductId);
                                ...
                                echo "</div>";
                                echo '<div class="product-group2" title="دسته بندی">';
                                ...
                                echo "</div>";
                                echo "</br>";
                                echo '<div class="product-group" title="دسته بندی">';
                                ...
                                echo "</div>";
                                if ($p->User->Name != 0) {
                                    echo '<div class="product-discount" title="تخفیف">';
                                    echo number_format($p->User->Name) . "%";
                                    echo "</div>";
                                }
                                if ($specialoffer == 1) {
                                    echo '<div class="product-specialoffer" title="پیشنهاد ویژه">';
                                ...
                                echo "</div>";
                                if ($p->User->UserId != 0) {
                                    echo '<div class="product-coupon" title="کپن دریافتی برای خرید محصول">';
