...
if (isset($_POST['group'])) {
    if ($_POST['group'] != 0) {
        $_SESSION[SESSION_STRING_GROUP_CK] = " And GroupId = " . $_POST['group'];
    } else {
        $_SESSION[SESSION_STRING_GROUP_CK] = '';
    }
}
if (isset($_POST['subgroup'])) {
    if ($_POST['subgroup'] != "" || $_POST['subgroup'] != 0) {
        $_SESSION[SESSION_STRING_SUB_GROUP_CK] = " And SubGroupId = " . $_POST['subgroup'];
    } else {
        $_SESSION[SESSION_STRING_SUB_GROUP_CK] = '';
    }
}
if (isset($_POST['suppergroup'])) {
    if ($_POST['suppergroup'] != "" || $_POST['suppergroup'] != 0) {
        $_SESSION[SESSION_STRING_SUPPER_GROUP_CK] = " And SupperGroupId = " . $_POST['suppergroup'];
    } else {
        $_SESSION[SESSION_STRING_SUPPER_GROUP_CK] = '';
    }
}
if (isset($_POST['order'])) {
    $_SESSION[SESSION_STRING_ORDER_CK] = $_POST['order'];
}
if (isset($_POST['ordertype'])) {
    $_SESSION[SESSION_STRING_ORDER_TYPE_CK] = $_POST['ordertype'];
}
if (isset($_POST['special_offer'])) {
    $_SESSION[SESSION_STRING_SPECIAL_OFFER] = $_POST['special_offer'];
}
if ((trim($_SESSION[SESSION_STRING_GROUP_CK]) == "" && trim($_SESSION[SESSION_STRING_SUB_GROUP_CK]) == "" && trim($_SESSION[SESSION_STRING_SUPPER_GROUP_CK]) == "" && trim($_SESSION[SESSION_STRING_SPECIAL_OFFER]) == "" && trim($_SESSION[SESSION_STRING_ORDER_CK]) == "ProductId" && trim($_SESSION[SESSION_STRING_ORDER_TYPE_CK]) == "DESC" && trim($_SESSION[SESSION_STRING_SEARCH_KEY_CK]) == "") || (isset($_POST['search_box']) && trim($_POST['search_box']) == "")) {
    ...
    $p->open();
    $products = $p->FindSpecialOffers2($_SESSION[SESSION_STRING_SPECIAL_OFFER]);
    $p->close();
} else {
    $p->open();
    $products = $p->AdvancedSearchProducts($_SESSION[SESSION_STRING_GROUP_CK], $_SESSION[SESSION_STRING_SUB_GROUP_CK], $_SESSION[SESSION_STRING_SUPPER_GROUP_CK], $_SESSION[SESSION_STRING_ORDER_CK], $_SESSION[SESSION_STRING_ORDER_TYPE_CK], $_SESSION[SESSION_STRING_SEARCH_KEY_CK]);
    $p->close();
}
?>
<?php
