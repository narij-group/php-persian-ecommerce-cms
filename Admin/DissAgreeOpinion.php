...
$opinion->DissActivate($o->OpinionId);
$opinion->close();
...
<div style="padding: 20px;  width: auto;  font-size: 11pt;  text-align: right;  font-family: Arial; " >"' . $o->Value . '"<br/><br/>نظر شما به دلایلی رد شد!</div>
<br/>
<br/>
